...
module VexRiscv (
  ...
  assign _zz_142_ = _zz_86_[4 : 4];
  assign _zz_143_ = _zz_86_[5 : 5];
  assign _zz_144_ = _zz_86_[6 : 6];
  assign _zz_145_ = _zz_86_[7 : 7];
  ...
  assign _zz_175_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001100100)) == (32'b00000000000000000000000000100100));
  assign _zz_176_ = ((decode_INSTRUCTION & _zz_184_) == (32'b00000000000000000100000000010000));
  assign _zz_177_ = ((decode_INSTRUCTION & _zz_185_) == (32'b00000000000000000001000000010000));
  assign _zz_178_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_179_ = {(_zz_186_ == _zz_187_),{_zz_188_,{_zz_189_,_zz_190_}}};
  assign _zz_180_ = (4'b0000);
  assign _zz_181_ = ({_zz_191_,_zz_90_} != (2'b00));
  assign _zz_182_ = ({_zz_192_,_zz_193_} != (2'b00));
  assign _zz_183_ = {(_zz_194_ != _zz_195_),{_zz_196_,{_zz_197_,_zz_198_}}};
  assign _zz_184_ = (32'b00000000000000000100000000010100);
  assign _zz_185_ = (32'b00000000000000000011000000010100);
  assign _zz_186_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_187_ = (32'b00000000000000000000000000000000);
  assign _zz_188_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_189_ = ((decode_INSTRUCTION & _zz_199_) == (32'b00000000000000000010000000000000));
  assign _zz_190_ = ((decode_INSTRUCTION & _zz_200_) == (32'b00000000000000000001000000000000));
  assign _zz_191_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_192_ = ((decode_INSTRUCTION & _zz_201_) == (32'b00000000000000000000000000000100));
  assign _zz_193_ = _zz_90_;
  assign _zz_194_ = ((decode_INSTRUCTION & _zz_202_) == (32'b00000000000000000101000000010000));
  assign _zz_195_ = (1'b0);
  assign _zz_196_ = ({_zz_203_,_zz_204_} != (2'b00));
  assign _zz_197_ = ({_zz_205_,_zz_206_} != (2'b00));
  assign _zz_198_ = {(_zz_207_ != _zz_208_),{_zz_209_,{_zz_210_,_zz_211_}}};
  assign _zz_199_ = (32'b00000000000000000110000000000100);
  assign _zz_200_ = (32'b00000000000000000101000000000100);
  assign _zz_201_ = (32'b00000000000000000000000001000100);
  assign _zz_202_ = (32'b00000000000000000111000001010100);
  assign _zz_203_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_204_ = ((decode_INSTRUCTION & (32'b00000000000000000111000001010100)) == (32'b00000000000000000001000000010000));
  assign _zz_205_ = _zz_88_;
  assign _zz_206_ = ((decode_INSTRUCTION & _zz_212_) == (32'b00000000000000000000000000000100));
  assign _zz_207_ = ((decode_INSTRUCTION & _zz_213_) == (32'b00000000000000000000000001000000));
  assign _zz_208_ = (1'b0);
  assign _zz_209_ = ({_zz_214_,_zz_89_} != (2'b00));
  assign _zz_210_ = ({_zz_215_,_zz_216_} != (3'b000));
  assign _zz_211_ = {(_zz_217_ != _zz_218_),{_zz_219_,{_zz_220_,_zz_221_}}};
  assign _zz_212_ = (32'b00000000000000000001000000010100);
  assign _zz_213_ = (32'b00000000000000000000000001011000);
  assign _zz_214_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_215_ = _zz_89_;
  assign _zz_216_ = {(_zz_222_ == _zz_223_),(_zz_224_ == _zz_225_)};
  assign _zz_217_ = {_zz_89_,(_zz_226_ == _zz_227_)};
  assign _zz_218_ = (2'b00);
  assign _zz_219_ = ({_zz_89_,_zz_228_} != (2'b00));
  assign _zz_220_ = (_zz_229_ != (1'b0));
  assign _zz_221_ = {(_zz_230_ != _zz_231_),{_zz_232_,{_zz_233_,_zz_234_}}};
  assign _zz_222_ = (decode_INSTRUCTION & (32'b00000000000000000011000000000000));
  assign _zz_223_ = (32'b00000000000000000001000000000000);
  assign _zz_224_ = (decode_INSTRUCTION & (32'b00000000000000000011000000000000));
  assign _zz_225_ = (32'b00000000000000000010000000000000);
  assign _zz_226_ = (decode_INSTRUCTION & (32'b00000000000000000000000001110000));
  assign _zz_227_ = (32'b00000000000000000000000000100000);
  assign _zz_228_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000000000));
  assign _zz_229_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000000000)) == (32'b00000000000000000000000000000000));
  assign _zz_230_ = _zz_87_;
  ...
  assign _zz_234_ = {({_zz_242_,_zz_243_} != (2'b00)),{(_zz_244_ != _zz_245_),{_zz_246_,{_zz_247_,_zz_248_}}}};
  ...
  assign _zz_239_ = ((decode_INSTRUCTION & _zz_249_) == (32'b00000000000000000000000001000000));
  assign _zz_240_ = (_zz_250_ == _zz_251_);
  assign _zz_241_ = (_zz_252_ == _zz_253_);
  assign _zz_242_ = (_zz_254_ == _zz_255_);
  assign _zz_243_ = (_zz_256_ == _zz_257_);
  assign _zz_244_ = {_zz_88_,{_zz_258_,_zz_259_}};
  assign _zz_245_ = (6'b000000);
  ...
  assign _zz_250_ = (decode_INSTRUCTION & (32'b01000000000000000000000000110000));
  assign _zz_251_ = (32'b01000000000000000000000000110000);
  assign _zz_252_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010100));
  assign _zz_253_ = (32'b00000000000000000010000000010000);
  assign _zz_254_ = (decode_INSTRUCTION & (32'b00000000000000000001000001010000));
  assign _zz_255_ = (32'b00000000000000000001000001010000);
  assign _zz_256_ = (decode_INSTRUCTION & (32'b00000000000000000010000001010000));
  assign _zz_257_ = (32'b00000000000000000010000001010000);
  assign _zz_258_ = ((decode_INSTRUCTION & _zz_266_) == (32'b00000000000000000001000000010000));
  assign _zz_259_ = {(_zz_267_ == _zz_268_),{_zz_269_,{_zz_270_,_zz_271_}}};
  assign _zz_260_ = ((decode_INSTRUCTION & _zz_272_) == (32'b00000000000000000000000000100000));
  assign _zz_261_ = ((decode_INSTRUCTION & _zz_273_) == (32'b00000000000000000000000000100000));
  assign _zz_262_ = ((decode_INSTRUCTION & _zz_274_) == (32'b00000000000000000000000001010000));
  assign _zz_263_ = (1'b0);
  assign _zz_264_ = ({_zz_275_,_zz_276_} != (2'b00));
  assign _zz_265_ = ((_zz_277_ == _zz_278_) != (1'b0));
  assign _zz_266_ = (32'b00000000000000000001000000010000);
  assign _zz_267_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_268_ = (32'b00000000000000000010000000010000);
  assign _zz_269_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_270_ = _zz_87_;
  assign _zz_271_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000000000));
  assign _zz_272_ = (32'b00000000000000000000000000110100);
  assign _zz_273_ = (32'b00000000000000000000000001100100);
  assign _zz_274_ = (32'b00010000000000000011000001010000);
  assign _zz_275_ = ((decode_INSTRUCTION & (32'b00010000000100000011000001010000)) == (32'b00000000000100000000000001010000));
  assign _zz_276_ = ((decode_INSTRUCTION & (32'b00010000010000000011000001010000)) == (32'b00010000000000000000000001010000));
  assign _zz_277_ = (decode_INSTRUCTION & (32'b00000000000000000000000000010000));
  assign _zz_278_ = (32'b00000000000000000000000000010000);
  initial begin
  ...
  assign _zz_86_ = {(((decode_INSTRUCTION & _zz_174_) == (32'b00000000000000000000000000000000)) != (1'b0)),{({_zz_175_,{_zz_176_,_zz_177_}} != (3'b000)),{(_zz_178_ != (1'b0)),{(_zz_179_ != _zz_180_),{_zz_181_,{_zz_182_,_zz_183_}}}}}};
  assign _zz_91_ = _zz_86_[2 : 1];
  assign _zz_53_ = _zz_91_;
  assign _zz_52_ = _zz_142_[0];
  assign _zz_51_ = _zz_143_[0];
  assign _zz_50_ = _zz_144_[0];
  assign _zz_49_ = _zz_145_[0];
  assign _zz_92_ = _zz_86_[11 : 10];
  assign _zz_48_ = _zz_92_;
  assign _zz_93_ = _zz_86_[13 : 12];
  assign _zz_47_ = _zz_93_;
