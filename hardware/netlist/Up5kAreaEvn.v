...
module VexRiscv (
  ...
  assign _zz_144_ = _zz_87_[6 : 6];
  assign _zz_145_ = _zz_87_[9 : 9];
  assign _zz_146_ = _zz_87_[12 : 12];
  assign _zz_147_ = _zz_87_[16 : 16];
  assign _zz_148_ = _zz_87_[23 : 23];
  ...
  assign _zz_176_ = (32'b00000000000000000000000001010000);
  assign _zz_177_ = ((decode_INSTRUCTION & (32'b00010000000000000011000001010000)) == (32'b00000000000000000000000001010000));
  assign _zz_178_ = {(_zz_183_ == _zz_184_),(_zz_185_ == _zz_186_)};
  assign _zz_179_ = (2'b00);
  assign _zz_180_ = ({_zz_187_,{_zz_188_,_zz_189_}} != (3'b000));
  assign _zz_181_ = (_zz_190_ != (1'b0));
  assign _zz_182_ = {(_zz_191_ != _zz_192_),{_zz_193_,{_zz_194_,_zz_195_}}};
  assign _zz_183_ = (decode_INSTRUCTION & (32'b00010000000100000011000001010000));
  assign _zz_184_ = (32'b00000000000100000000000001010000);
  assign _zz_185_ = (decode_INSTRUCTION & (32'b00010000010000000011000001010000));
  assign _zz_186_ = (32'b00010000000000000000000001010000);
  assign _zz_187_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001100100)) == (32'b00000000000000000000000000100100));
  assign _zz_188_ = ((decode_INSTRUCTION & _zz_196_) == (32'b00000000000000000100000000010000));
  assign _zz_189_ = ((decode_INSTRUCTION & _zz_197_) == (32'b00000000000000000001000000010000));
  assign _zz_190_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_191_ = {(_zz_198_ == _zz_199_),(_zz_200_ == _zz_201_)};
  assign _zz_192_ = (2'b00);
  assign _zz_193_ = ({_zz_88_,{_zz_202_,_zz_203_}} != (5'b00000));
  assign _zz_194_ = ({_zz_204_,_zz_205_} != (2'b00));
  assign _zz_195_ = {(_zz_206_ != _zz_207_),{_zz_208_,{_zz_209_,_zz_210_}}};
  assign _zz_196_ = (32'b00000000000000000100000000010100);
  assign _zz_197_ = (32'b00000000000000000011000000010100);
  assign _zz_198_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_199_ = (32'b00000000000000000000000000100000);
  assign _zz_200_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_201_ = (32'b00000000000000000000000000100000);
  assign _zz_202_ = _zz_90_;
  assign _zz_203_ = {(_zz_211_ == _zz_212_),{_zz_213_,_zz_92_}};
  assign _zz_204_ = _zz_89_;
  assign _zz_205_ = _zz_91_;
  assign _zz_206_ = {(_zz_214_ == _zz_215_),_zz_91_};
  assign _zz_207_ = (2'b00);
  assign _zz_208_ = ((_zz_216_ == _zz_217_) != (1'b0));
  assign _zz_209_ = ({_zz_218_,_zz_219_} != (3'b000));
  assign _zz_210_ = {(_zz_220_ != _zz_221_),{_zz_222_,{_zz_223_,_zz_224_}}};
  assign _zz_211_ = (decode_INSTRUCTION & (32'b00000000000000000001000000010000));
  assign _zz_212_ = (32'b00000000000000000001000000010000);
  assign _zz_213_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000010000));
  assign _zz_214_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_215_ = (32'b00000000000000000000000000000100);
  assign _zz_216_ = (decode_INSTRUCTION & (32'b00000000000000000000000000000000));
  assign _zz_217_ = (32'b00000000000000000000000000000000);
  assign _zz_218_ = ((decode_INSTRUCTION & _zz_225_) == (32'b00000000000000000000000001000000));
  assign _zz_219_ = {(_zz_226_ == _zz_227_),(_zz_228_ == _zz_229_)};
  assign _zz_220_ = ((decode_INSTRUCTION & _zz_230_) == (32'b00000000000000000101000000010000));
  assign _zz_221_ = (1'b0);
  assign _zz_222_ = ({_zz_231_,_zz_232_} != (2'b00));
  assign _zz_223_ = ({_zz_233_,_zz_234_} != (2'b00));
  assign _zz_224_ = {(_zz_235_ != _zz_236_),{_zz_237_,{_zz_238_,_zz_239_}}};
  assign _zz_225_ = (32'b00000000000000000000000001000100);
  assign _zz_226_ = (decode_INSTRUCTION & (32'b01000000000000000000000000110000));
  assign _zz_227_ = (32'b01000000000000000000000000110000);
  assign _zz_228_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010100));
  assign _zz_229_ = (32'b00000000000000000010000000010000);
  assign _zz_230_ = (32'b00000000000000000111000001010100);
  assign _zz_231_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_232_ = ((decode_INSTRUCTION & (32'b00000000000000000111000001010100)) == (32'b00000000000000000001000000010000));
  assign _zz_233_ = ((decode_INSTRUCTION & _zz_240_) == (32'b00000000000000000010000000000000));
  assign _zz_234_ = ((decode_INSTRUCTION & _zz_241_) == (32'b00000000000000000001000000000000));
  assign _zz_235_ = {_zz_88_,(_zz_242_ == _zz_243_)};
  assign _zz_236_ = (2'b00);
  assign _zz_237_ = ({_zz_88_,_zz_90_} != (2'b00));
  assign _zz_238_ = ({_zz_244_,_zz_245_} != (2'b00));
  assign _zz_239_ = {(_zz_246_ != _zz_247_),{_zz_248_,{_zz_249_,_zz_250_}}};
  assign _zz_240_ = (32'b00000000000000000010000000010000);
  assign _zz_241_ = (32'b00000000000000000101000000000000);
  assign _zz_242_ = (decode_INSTRUCTION & (32'b00000000000000000000000001110000));
  assign _zz_243_ = (32'b00000000000000000000000000100000);
  assign _zz_244_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001010000)) == (32'b00000000000000000001000001010000));
  assign _zz_245_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000001010000));
  assign _zz_246_ = _zz_89_;
  assign _zz_247_ = (1'b0);
  assign _zz_248_ = (((decode_INSTRUCTION & _zz_251_) == (32'b00000000000000000000000001000000)) != (1'b0));
  assign _zz_249_ = ((_zz_252_ == _zz_253_) != (1'b0));
  assign _zz_250_ = {({_zz_254_,_zz_255_} != (2'b00)),{(_zz_256_ != _zz_257_),(_zz_258_ != _zz_259_)}};
  assign _zz_251_ = (32'b00000000000000000000000001011000);
  assign _zz_252_ = (decode_INSTRUCTION & (32'b00000000000000000000000000010000));
  assign _zz_253_ = (32'b00000000000000000000000000010000);
  assign _zz_254_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_255_ = _zz_88_;
  assign _zz_256_ = {_zz_88_,{((decode_INSTRUCTION & _zz_260_) == (32'b00000000000000000001000000000000)),((decode_INSTRUCTION & _zz_261_) == (32'b00000000000000000010000000000000))}};
  assign _zz_257_ = (3'b000);
  assign _zz_258_ = {((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000000000000)),{((decode_INSTRUCTION & _zz_262_) == (32'b00000000000000000000000000000000)),{(_zz_263_ == _zz_264_),(_zz_265_ == _zz_266_)}}};
  assign _zz_259_ = (4'b0000);
  assign _zz_260_ = (32'b00000000000000000011000000000000);
  assign _zz_261_ = (32'b00000000000000000011000000000000);
  assign _zz_262_ = (32'b00000000000000000000000000011000);
  assign _zz_263_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_264_ = (32'b00000000000000000010000000000000);
  assign _zz_265_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000100));
  assign _zz_266_ = (32'b00000000000000000001000000000000);
  assign _zz_267_ = (32'b00000000000000000001000001111111);
  assign _zz_268_ = (decode_INSTRUCTION & (32'b00000000000000000010000001111111));
  assign _zz_269_ = (32'b00000000000000000010000001110011);
  assign _zz_270_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001111111)) == (32'b00000000000000000100000001100011));
  assign _zz_271_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000010000000010011));
  assign _zz_272_ = {((decode_INSTRUCTION & (32'b00000000000000000110000000111111)) == (32'b00000000000000000000000000100011)),{((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_273_) == (32'b00000000000000000000000000000011)),{(_zz_274_ == _zz_275_),{_zz_276_,{_zz_277_,_zz_278_}}}}}};
  assign _zz_273_ = (32'b00000000000000000101000001011111);
  assign _zz_274_ = (decode_INSTRUCTION & (32'b00000000000000000111000001111011));
  assign _zz_275_ = (32'b00000000000000000000000001100011);
  assign _zz_276_ = ((decode_INSTRUCTION & (32'b11111110000000000000000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_277_ = ((decode_INSTRUCTION & (32'b10111100000000000111000001111111)) == (32'b00000000000000000101000000010011));
  assign _zz_278_ = {((decode_INSTRUCTION & (32'b11111100000000000011000001111111)) == (32'b00000000000000000001000000010011)),{((decode_INSTRUCTION & (32'b10111110000000000111000001111111)) == (32'b00000000000000000101000000110011)),{((decode_INSTRUCTION & _zz_279_) == (32'b00000000000000000000000000110011)),{(_zz_280_ == _zz_281_),{_zz_282_,_zz_283_}}}}};
  assign _zz_279_ = (32'b10111110000000000111000001111111);
  assign _zz_280_ = (decode_INSTRUCTION & (32'b11011111111111111111111111111111));
  assign _zz_281_ = (32'b00010000001000000000000001110011);
  assign _zz_282_ = ((decode_INSTRUCTION & (32'b11111111111011111111111111111111)) == (32'b00000000000000000000000001110011));
  assign _zz_283_ = ((decode_INSTRUCTION & (32'b11111111111111111111111111111111)) == (32'b00010000010100000000000001110011));
  initial begin
  ...
  assign _zz_89_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_90_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000000000));
  ...
  assign _zz_87_ = {(((decode_INSTRUCTION & _zz_176_) == (32'b00000000000000000000000000000000)) != (1'b0)),{(_zz_92_ != (1'b0)),{(_zz_177_ != (1'b0)),{(_zz_178_ != _zz_179_),{_zz_180_,{_zz_181_,_zz_182_}}}}}};
  assign _zz_54_ = ({((decode_INSTRUCTION & (32'b00000000000000000000000001011111)) == (32'b00000000000000000000000000010111)),{((decode_INSTRUCTION & (32'b00000000000000000000000001111111)) == (32'b00000000000000000000000001101111)),{((decode_INSTRUCTION & (32'b00000000000000000001000001101111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_267_) == (32'b00000000000000000001000001110011)),{(_zz_268_ == _zz_269_),{_zz_270_,{_zz_271_,_zz_272_}}}}}}} != (19'b0000000000000000000));
  assign _zz_93_ = _zz_87_[2 : 1];
  assign _zz_53_ = _zz_93_;
  assign _zz_94_ = _zz_87_[5 : 4];
  assign _zz_52_ = _zz_94_;
  assign _zz_51_ = _zz_144_[0];
  assign _zz_95_ = _zz_87_[8 : 7];
  assign _zz_50_ = _zz_95_;
  assign _zz_49_ = _zz_145_[0];
  assign _zz_96_ = _zz_87_[11 : 10];
  assign _zz_48_ = _zz_96_;
  assign _zz_47_ = _zz_146_[0];
  ...
  assign CsrPlugin_mtvec_base = (30'b000000000000000000000000000010);
