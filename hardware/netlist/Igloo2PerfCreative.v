...
module VexRiscv (
  ...
  wire  _zz_131_;
  wire  _zz_132_;
  wire `ShiftCtrlEnum_defaultEncoding_type _zz_133_;
  wire `EnvCtrlEnum_defaultEncoding_type _zz_134_;
  wire `BranchCtrlEnum_defaultEncoding_type _zz_135_;
  wire `Src2CtrlEnum_defaultEncoding_type _zz_136_;
  wire `AluCtrlEnum_defaultEncoding_type _zz_137_;
  wire `AluBitwiseCtrlEnum_defaultEncoding_type _zz_138_;
  ...
  assign _zz_222_ = _zz_127_[4 : 4];
  assign _zz_223_ = _zz_127_[5 : 5];
  assign _zz_224_ = _zz_127_[6 : 6];
  assign _zz_225_ = _zz_127_[9 : 9];
  assign _zz_226_ = _zz_127_[10 : 10];
  assign _zz_227_ = _zz_127_[11 : 11];
  assign _zz_228_ = _zz_127_[14 : 14];
  assign _zz_229_ = _zz_127_[15 : 15];
  assign _zz_230_ = _zz_127_[18 : 18];
  assign _zz_231_ = _zz_127_[19 : 19];
  ...
  assign _zz_284_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000000000100));
  ...
  assign _zz_288_ = (4'b0000);
  assign _zz_289_ = ({_zz_299_,_zz_129_} != (2'b00));
  assign _zz_290_ = ({_zz_300_,_zz_301_} != (2'b00));
  assign _zz_291_ = {(_zz_302_ != _zz_303_),{_zz_304_,{_zz_305_,_zz_306_}}};
  assign _zz_292_ = (32'b00000000000000000010000000010000);
  assign _zz_293_ = (32'b00000000000000000101000000000000);
  assign _zz_294_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_295_ = (32'b00000000000000000000000000000000);
  assign _zz_296_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_297_ = ((decode_INSTRUCTION & _zz_307_) == (32'b00000000000000000010000000000000));
  assign _zz_298_ = ((decode_INSTRUCTION & _zz_308_) == (32'b00000000000000000001000000000000));
  assign _zz_299_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_300_ = _zz_129_;
  assign _zz_301_ = ((decode_INSTRUCTION & _zz_309_) == (32'b00000000000000000010000000000000));
  assign _zz_302_ = {(_zz_310_ == _zz_311_),(_zz_312_ == _zz_313_)};
  assign _zz_303_ = (2'b00);
  assign _zz_304_ = ((_zz_314_ == _zz_315_) != (1'b0));
  assign _zz_305_ = (_zz_316_ != (1'b0));
  assign _zz_306_ = {(_zz_317_ != _zz_318_),{_zz_319_,{_zz_320_,_zz_321_}}};
  assign _zz_307_ = (32'b00000000000000000110000000000100);
  assign _zz_308_ = (32'b00000000000000000101000000000100);
  ...
  assign _zz_312_ = (decode_INSTRUCTION & (32'b00000000000000000100000000010100));
  assign _zz_313_ = (32'b00000000000000000100000000010000);
  assign _zz_314_ = (decode_INSTRUCTION & (32'b00000000000000000110000000010100));
  assign _zz_315_ = (32'b00000000000000000010000000010000);
  assign _zz_316_ = ((decode_INSTRUCTION & (32'b00000010000000000100000001100100)) == (32'b00000010000000000100000000100000));
  assign _zz_317_ = {(_zz_322_ == _zz_323_),(_zz_324_ == _zz_325_)};
  assign _zz_318_ = (2'b00);
  assign _zz_319_ = ({_zz_129_,_zz_326_} != (2'b00));
  assign _zz_320_ = ({_zz_327_,_zz_328_} != (2'b00));
  assign _zz_321_ = {(_zz_329_ != _zz_330_),{_zz_331_,{_zz_332_,_zz_333_}}};
  assign _zz_322_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_323_ = (32'b00000000000000000000000000100000);
  assign _zz_324_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_325_ = (32'b00000000000000000000000000100000);
  assign _zz_326_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001110000)) == (32'b00000000000000000000000000100000));
  assign _zz_327_ = _zz_129_;
  assign _zz_328_ = _zz_130_;
  assign _zz_329_ = _zz_128_;
  assign _zz_330_ = (1'b0);
  assign _zz_331_ = ({(_zz_334_ == _zz_335_),(_zz_336_ == _zz_337_)} != (2'b00));
  assign _zz_332_ = (_zz_131_ != (1'b0));
  assign _zz_333_ = {(_zz_338_ != (1'b0)),{(_zz_339_ != _zz_340_),{_zz_341_,{_zz_342_,_zz_343_}}}};
  assign _zz_334_ = (decode_INSTRUCTION & (32'b00000000000000000001000001010000));
  assign _zz_335_ = (32'b00000000000000000001000001010000);
  assign _zz_336_ = (decode_INSTRUCTION & (32'b00000000000000000010000001010000));
  assign _zz_337_ = (32'b00000000000000000010000001010000);
  assign _zz_338_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  assign _zz_339_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000000000));
  assign _zz_340_ = (1'b0);
  assign _zz_341_ = ({(_zz_344_ == _zz_345_),{_zz_346_,_zz_347_}} != (3'b000));
  assign _zz_342_ = ({_zz_129_,{_zz_348_,_zz_349_}} != (5'b00000));
  assign _zz_343_ = {(_zz_350_ != (1'b0)),{(_zz_351_ != _zz_352_),{_zz_353_,{_zz_354_,_zz_355_}}}};
  ...
  assign _zz_346_ = ((decode_INSTRUCTION & (32'b01000000000000000000000000110000)) == (32'b01000000000000000000000000110000));
  assign _zz_347_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_348_ = _zz_130_;
  assign _zz_349_ = {(_zz_356_ == _zz_357_),{_zz_358_,_zz_359_}};
  ...
  assign _zz_353_ = ((_zz_364_ == _zz_365_) != (1'b0));
  assign _zz_354_ = ({_zz_366_,_zz_367_} != (5'b00000));
  assign _zz_355_ = {(_zz_368_ != _zz_369_),{_zz_370_,{_zz_371_,_zz_372_}}};
  assign _zz_356_ = (decode_INSTRUCTION & (32'b00000000000000000001000000010000));
  assign _zz_357_ = (32'b00000000000000000001000000010000);
  assign _zz_358_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000010000));
  assign _zz_359_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000010000));
  assign _zz_360_ = (decode_INSTRUCTION & (32'b00010000000100000011000001010000));
  assign _zz_361_ = (32'b00000000000100000000000001010000);
  ...
  assign _zz_366_ = _zz_129_;
  assign _zz_367_ = {(_zz_373_ == _zz_374_),{_zz_375_,{_zz_376_,_zz_377_}}};
  assign _zz_368_ = {(_zz_378_ == _zz_379_),{_zz_129_,{_zz_380_,_zz_381_}}};
  assign _zz_369_ = (5'b00000);
  assign _zz_370_ = ({_zz_382_,{_zz_383_,_zz_384_}} != (3'b000));
  assign _zz_371_ = ({_zz_385_,_zz_386_} != (2'b00));
  assign _zz_372_ = {(_zz_387_ != _zz_388_),(_zz_389_ != _zz_390_)};
  assign _zz_373_ = (decode_INSTRUCTION & (32'b00000000000000000010000000110000));
  assign _zz_374_ = (32'b00000000000000000010000000010000);
  assign _zz_375_ = ((decode_INSTRUCTION & _zz_391_) == (32'b00000000000000000010000000100000));
  assign _zz_376_ = (_zz_392_ == _zz_393_);
  assign _zz_377_ = (_zz_394_ == _zz_395_);
  assign _zz_378_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000000));
  assign _zz_379_ = (32'b00000000000000000000000001000000);
  assign _zz_380_ = (_zz_396_ == _zz_397_);
  assign _zz_381_ = {_zz_398_,_zz_399_};
  assign _zz_382_ = ((decode_INSTRUCTION & _zz_400_) == (32'b00000000000000000000000001000000));
  assign _zz_383_ = (_zz_401_ == _zz_402_);
  assign _zz_384_ = (_zz_403_ == _zz_404_);
  assign _zz_385_ = (_zz_405_ == _zz_406_);
  assign _zz_386_ = (_zz_407_ == _zz_408_);
  assign _zz_387_ = {_zz_409_,{_zz_410_,_zz_411_}};
  assign _zz_388_ = (3'b000);
  assign _zz_389_ = _zz_128_;
  assign _zz_390_ = (1'b0);
  assign _zz_391_ = (32'b00000010000000000010000000100000);
  assign _zz_392_ = (decode_INSTRUCTION & (32'b00000010000000000001000000100000));
  assign _zz_393_ = (32'b00000000000000000000000000100000);
  assign _zz_394_ = (decode_INSTRUCTION & (32'b00000000000000000001000000110000));
  assign _zz_395_ = (32'b00000000000000000000000000010000);
  assign _zz_396_ = (decode_INSTRUCTION & (32'b00000000000000000100000000100000));
  assign _zz_397_ = (32'b00000000000000000100000000100000);
  assign _zz_398_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000110000)) == (32'b00000000000000000000000000010000));
  assign _zz_399_ = ((decode_INSTRUCTION & (32'b00000010000000000000000000100000)) == (32'b00000000000000000000000000100000));
  ...
  assign _zz_405_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_406_ = (32'b00000000000000000101000000010000);
  assign _zz_407_ = (decode_INSTRUCTION & (32'b00000010000000000111000001100100));
  assign _zz_408_ = (32'b00000000000000000101000000100000);
  assign _zz_409_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_410_ = ((decode_INSTRUCTION & (32'b00000000000000000111000000110100)) == (32'b00000000000000000001000000010000));
  assign _zz_411_ = ((decode_INSTRUCTION & (32'b00000010000000000111000001010100)) == (32'b00000000000000000001000000010000));
  always @ (posedge io_clk) begin
    if(_zz_49_) begin
  ...
  assign _zz_128_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000000000000000000));
  assign _zz_129_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_130_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000000000));
  assign _zz_131_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_132_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001010000)) == (32'b00000000000000000100000001010000));
  assign _zz_127_ = {({_zz_131_,_zz_132_} != (2'b00)),{({_zz_284_,_zz_132_} != (2'b00)),{({_zz_285_,_zz_286_} != (2'b00)),{(_zz_287_ != _zz_288_),{_zz_289_,{_zz_290_,_zz_291_}}}}}};
  assign _zz_71_ = _zz_221_[0];
  assign _zz_133_ = _zz_127_[2 : 1];
  assign _zz_70_ = _zz_133_;
  assign _zz_69_ = _zz_222_[0];
  assign _zz_68_ = _zz_223_[0];
  assign _zz_67_ = _zz_224_[0];
  assign _zz_134_ = _zz_127_[8 : 7];
  assign _zz_66_ = _zz_134_;
  assign _zz_65_ = _zz_225_[0];
  assign _zz_64_ = _zz_226_[0];
  assign _zz_63_ = _zz_227_[0];
  assign _zz_135_ = _zz_127_[13 : 12];
  assign _zz_62_ = _zz_135_;
  assign _zz_61_ = _zz_228_[0];
  assign _zz_60_ = _zz_229_[0];
  assign _zz_136_ = _zz_127_[17 : 16];
  assign _zz_59_ = _zz_136_;
  assign _zz_58_ = _zz_230_[0];
  assign _zz_57_ = _zz_231_[0];
  assign _zz_137_ = _zz_127_[21 : 20];
  assign _zz_56_ = _zz_137_;
  assign _zz_138_ = _zz_127_[23 : 22];
  assign _zz_55_ = _zz_138_;
...
module Igloo2Perf (
  ...
  reg [21:0] resetCtrl_systemClkResetCounter = (22'b0000000000000000000000);
  wire [21:0] _zz_1_;
  ...
  assign _zz_1_[21 : 0] = (22'b1111111111111111111111);
  ...
  always @ (posedge io_clk) begin
    if(_zz_172_)begin
      resetCtrl_systemClkResetCounter <= (resetCtrl_systemClkResetCounter + (22'b0000000000000000000001));
    end
    if(_zz_47_)begin
      resetCtrl_systemClkResetCounter <= (22'b0000000000000000000000);
    end
  end
