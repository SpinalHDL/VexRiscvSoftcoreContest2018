...
module VexRiscv (
  ...
  assign _zz_238_ = _zz_135_[0 : 0];
  assign _zz_239_ = _zz_135_[3 : 3];
  assign _zz_240_ = _zz_135_[11 : 11];
  assign _zz_241_ = _zz_135_[12 : 12];
  assign _zz_242_ = _zz_135_[13 : 13];
  assign _zz_243_ = _zz_135_[14 : 14];
  assign _zz_244_ = _zz_135_[15 : 15];
  assign _zz_245_ = _zz_135_[18 : 18];
  assign _zz_246_ = _zz_135_[21 : 21];
  assign _zz_247_ = _zz_135_[24 : 24];
  assign _zz_248_ = _zz_135_[25 : 25];
  ...
  assign _zz_302_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_303_ = (32'b00000000000000000000000000100000);
  assign _zz_304_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_305_ = (32'b00000000000000000000000000100000);
  assign _zz_306_ = ((decode_INSTRUCTION & _zz_316_) == (32'b00000000000000000000000001001000));
  assign _zz_307_ = (_zz_317_ == _zz_318_);
  assign _zz_308_ = {_zz_319_,{_zz_320_,_zz_321_}};
  assign _zz_309_ = (_zz_322_ == _zz_323_);
  assign _zz_310_ = {_zz_137_,{_zz_324_,_zz_325_}};
  ...
  assign _zz_316_ = (32'b00000000000000000000000001001000);
  assign _zz_317_ = (decode_INSTRUCTION & (32'b00000000000000000001000000010000));
  assign _zz_318_ = (32'b00000000000000000001000000010000);
  assign _zz_319_ = ((decode_INSTRUCTION & _zz_335_) == (32'b00000000000000000010000000010000));
  assign _zz_320_ = (_zz_336_ == _zz_337_);
  assign _zz_321_ = {_zz_338_,_zz_339_};
  assign _zz_322_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000000));
  assign _zz_323_ = (32'b00000000000000000000000001000000);
  assign _zz_324_ = (_zz_340_ == _zz_341_);
  assign _zz_325_ = {_zz_342_,_zz_343_};
  assign _zz_326_ = ((decode_INSTRUCTION & _zz_344_) == (32'b00000000000000000010000000000000));
  assign _zz_327_ = ((decode_INSTRUCTION & _zz_345_) == (32'b00000000000000000001000000000000));
  assign _zz_328_ = (_zz_346_ == _zz_347_);
  assign _zz_329_ = (_zz_348_ == _zz_349_);
  assign _zz_330_ = {_zz_138_,_zz_139_};
  assign _zz_331_ = (2'b00);
  assign _zz_332_ = ({_zz_350_,_zz_351_} != (2'b00));
  assign _zz_333_ = (_zz_352_ != _zz_353_);
  assign _zz_334_ = {_zz_354_,{_zz_355_,_zz_356_}};
  assign _zz_335_ = (32'b00000000000000000010000000010000);
  assign _zz_336_ = (decode_INSTRUCTION & (32'b00000000000000000001000000000100));
  assign _zz_337_ = (32'b00000000000000000000000000000100);
  assign _zz_338_ = ((decode_INSTRUCTION & _zz_357_) == (32'b00000000000000000000000000010000));
  assign _zz_339_ = ((decode_INSTRUCTION & _zz_358_) == (32'b00000000000000000000000000000000));
  assign _zz_340_ = (decode_INSTRUCTION & (32'b00000000000000000100000000100000));
  assign _zz_341_ = (32'b00000000000000000100000000100000);
  assign _zz_342_ = ((decode_INSTRUCTION & _zz_359_) == (32'b00000000000000000000000000010000));
  assign _zz_343_ = ((decode_INSTRUCTION & _zz_360_) == (32'b00000000000000000000000000100000));
  assign _zz_344_ = (32'b00000000000000000010000000010000);
  assign _zz_345_ = (32'b00000000000000000101000000000000);
  ...
  assign _zz_354_ = (_zz_138_ != (1'b0));
  assign _zz_355_ = (_zz_365_ != _zz_366_);
  assign _zz_356_ = {_zz_367_,{_zz_368_,_zz_369_}};
  assign _zz_357_ = (32'b00000000000000000000000001010000);
  assign _zz_358_ = (32'b00000000000000000000000000101000);
  assign _zz_359_ = (32'b00000000000000000000000000110000);
  assign _zz_360_ = (32'b00000010000000000000000000100000);
  assign _zz_361_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_362_ = (32'b00000000000000000000000000000100);
  ...
  assign _zz_365_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  assign _zz_366_ = (1'b0);
  assign _zz_367_ = (((decode_INSTRUCTION & _zz_370_) == (32'b00000000000000000000000000001000)) != (1'b0));
  assign _zz_368_ = ({_zz_137_,_zz_371_} != (2'b00));
  assign _zz_369_ = {({_zz_372_,_zz_373_} != (2'b00)),{(_zz_374_ != _zz_375_),{_zz_376_,{_zz_377_,_zz_378_}}}};
  assign _zz_370_ = (32'b00000000000000000000000001001000);
  assign _zz_371_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001110000)) == (32'b00000000000000000000000000100000));
  assign _zz_372_ = _zz_137_;
  assign _zz_373_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000000000));
  assign _zz_374_ = {_zz_137_,{(_zz_379_ == _zz_380_),{_zz_381_,{_zz_382_,_zz_383_}}}};
  assign _zz_375_ = (5'b00000);
  assign _zz_376_ = (_zz_136_ != (1'b0));
  assign _zz_377_ = ((_zz_384_ == _zz_385_) != (1'b0));
  assign _zz_378_ = {(_zz_386_ != (1'b0)),{(_zz_387_ != _zz_388_),{_zz_389_,{_zz_390_,_zz_391_}}}};
  assign _zz_379_ = (decode_INSTRUCTION & (32'b00000000000000000010000000110000));
  assign _zz_380_ = (32'b00000000000000000010000000010000);
  assign _zz_381_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000110000)) == (32'b00000000000000000000000000010000));
  assign _zz_382_ = ((decode_INSTRUCTION & _zz_392_) == (32'b00000000000000000010000000100000));
  assign _zz_383_ = ((decode_INSTRUCTION & _zz_393_) == (32'b00000000000000000000000000100000));
  assign _zz_384_ = (decode_INSTRUCTION & (32'b00000010000000000100000001110100));
  assign _zz_385_ = (32'b00000010000000000000000000110000);
  assign _zz_386_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000000000000));
  assign _zz_387_ = {(_zz_394_ == _zz_395_),{_zz_396_,_zz_397_}};
  assign _zz_388_ = (3'b000);
  assign _zz_389_ = ((_zz_398_ == _zz_399_) != (1'b0));
  assign _zz_390_ = ({_zz_400_,_zz_401_} != (2'b00));
  assign _zz_391_ = {(_zz_402_ != _zz_403_),{_zz_404_,{_zz_405_,_zz_406_}}};
  ...
  assign _zz_396_ = ((decode_INSTRUCTION & (32'b01000000000000000000000000110000)) == (32'b01000000000000000000000000110000));
  assign _zz_397_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_398_ = (decode_INSTRUCTION & (32'b00010000000000000011000001010000));
  assign _zz_399_ = (32'b00000000000000000000000001010000);
  assign _zz_400_ = ((decode_INSTRUCTION & _zz_407_) == (32'b00000000000100000000000001010000));
  assign _zz_401_ = ((decode_INSTRUCTION & _zz_408_) == (32'b00010000000000000000000001010000));
  assign _zz_402_ = {(_zz_409_ == _zz_410_),(_zz_411_ == _zz_412_)};
  assign _zz_403_ = (2'b00);
  assign _zz_404_ = ((_zz_413_ == _zz_414_) != (1'b0));
  assign _zz_405_ = ({_zz_415_,_zz_416_} != (2'b00));
  assign _zz_406_ = {(_zz_417_ != _zz_418_),{_zz_419_,{_zz_420_,_zz_421_}}};
  assign _zz_407_ = (32'b00010000000100000011000001010000);
  assign _zz_408_ = (32'b00010000010000000011000001010000);
  assign _zz_409_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_410_ = (32'b00000000000000000000000000100100);
  assign _zz_411_ = (decode_INSTRUCTION & (32'b00000000000000000100000000010100));
  assign _zz_412_ = (32'b00000000000000000100000000010000);
  assign _zz_413_ = (decode_INSTRUCTION & (32'b00000000000000000110000000010100));
  assign _zz_414_ = (32'b00000000000000000010000000010000);
  assign _zz_415_ = ((decode_INSTRUCTION & _zz_422_) == (32'b00000000000000000101000000010000));
  assign _zz_416_ = ((decode_INSTRUCTION & _zz_423_) == (32'b00000000000000000101000000100000));
  assign _zz_417_ = {(_zz_424_ == _zz_425_),{_zz_426_,_zz_427_}};
  assign _zz_418_ = (3'b000);
  assign _zz_419_ = ({_zz_428_,{_zz_429_,_zz_430_}} != (3'b000));
  assign _zz_420_ = ({_zz_431_,_zz_432_} != (4'b0000));
  assign _zz_421_ = {(_zz_433_ != _zz_434_),{_zz_435_,_zz_436_}};
  assign _zz_422_ = (32'b00000000000000000111000000110100);
  assign _zz_423_ = (32'b00000010000000000111000001100100);
  assign _zz_424_ = (decode_INSTRUCTION & (32'b01000000000000000011000001010100));
  assign _zz_425_ = (32'b01000000000000000001000000010000);
  assign _zz_426_ = ((decode_INSTRUCTION & _zz_437_) == (32'b00000000000000000001000000010000));
  assign _zz_427_ = ((decode_INSTRUCTION & _zz_438_) == (32'b00000000000000000001000000010000));
  assign _zz_428_ = ((decode_INSTRUCTION & _zz_439_) == (32'b00000000000000000000000001000000));
  ...
  assign _zz_433_ = {_zz_449_,_zz_137_};
  assign _zz_434_ = (2'b00);
  assign _zz_435_ = ({_zz_450_,_zz_451_} != (2'b00));
  assign _zz_436_ = (_zz_136_ != (1'b0));
  assign _zz_437_ = (32'b00000000000000000111000000110100);
  assign _zz_438_ = (32'b00000010000000000111000001010100);
  assign _zz_439_ = (32'b00000000000000000000000001010000);
  assign _zz_440_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110000));
  assign _zz_441_ = (32'b00000000000000000000000000000000);
  assign _zz_442_ = (decode_INSTRUCTION & (32'b00000000010000000011000001000000));
  assign _zz_443_ = (32'b00000000000000000000000001000000);
  assign _zz_444_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_445_ = (32'b00000000000000000000000000000000);
  assign _zz_446_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_447_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000000100)) == (32'b00000000000000000010000000000000));
  assign _zz_448_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000100)) == (32'b00000000000000000001000000000000));
  assign _zz_449_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_450_ = _zz_137_;
  assign _zz_451_ = ((decode_INSTRUCTION & (32'b00000000000000000011000000000000)) == (32'b00000000000000000010000000000000));
  always @ (posedge io_clk) begin
    if(_zz_92_) begin
  ...
  assign _zz_135_ = {({(_zz_302_ == _zz_303_),(_zz_304_ == _zz_305_)} != (2'b00)),{({_zz_306_,{_zz_307_,_zz_308_}} != (6'b000000)),{({_zz_309_,_zz_310_} != (5'b00000)),{(_zz_311_ != _zz_312_),{_zz_313_,{_zz_314_,_zz_315_}}}}}};
  assign _zz_75_ = _zz_238_[0];
  assign _zz_140_ = _zz_135_[2 : 1];
  assign _zz_74_ = _zz_140_;
  assign _zz_73_ = _zz_239_[0];
  assign _zz_141_ = _zz_135_[6 : 5];
  assign _zz_72_ = _zz_141_;
  assign _zz_142_ = _zz_135_[8 : 7];
  assign _zz_71_ = _zz_142_;
  assign _zz_143_ = _zz_135_[10 : 9];
  assign _zz_70_ = _zz_143_;
  assign _zz_69_ = _zz_240_[0];
  assign _zz_68_ = _zz_241_[0];
  assign _zz_67_ = _zz_242_[0];
  assign _zz_66_ = _zz_243_[0];
  assign _zz_65_ = _zz_244_[0];
  assign _zz_144_ = _zz_135_[17 : 16];
  assign _zz_64_ = _zz_144_;
  assign _zz_63_ = _zz_245_[0];
  assign _zz_145_ = _zz_135_[20 : 19];
  assign _zz_62_ = _zz_145_;
  assign _zz_61_ = _zz_246_[0];
  assign _zz_146_ = _zz_135_[23 : 22];
  assign _zz_60_ = _zz_146_;
...
module Igloo2Perf (
  ...
  reg [31:0] _zz_34_;
  reg [3:0] _zz_35_;
  assign _zz_168_ = (resetCtrl_resetCounter != _zz_1_);
