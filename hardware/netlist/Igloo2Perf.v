...
module VexRiscv (
  ...
  assign _zz_239_ = _zz_136_[0 : 0];
  assign _zz_240_ = _zz_136_[1 : 1];
  assign _zz_241_ = _zz_136_[2 : 2];
  assign _zz_242_ = _zz_136_[5 : 5];
  assign _zz_243_ = _zz_136_[10 : 10];
  assign _zz_244_ = _zz_136_[14 : 14];
  assign _zz_245_ = _zz_136_[19 : 19];
  assign _zz_246_ = _zz_136_[20 : 20];
  assign _zz_247_ = _zz_136_[21 : 21];
  assign _zz_248_ = _zz_136_[22 : 22];
  assign _zz_249_ = _zz_136_[23 : 23];
  assign _zz_250_ = _zz_136_[24 : 24];
  assign _zz_251_ = _zz_136_[27 : 27];
  assign _zz_252_ = _zz_136_[28 : 28];
  ...
  assign _zz_304_ = ((decode_INSTRUCTION & _zz_317_) == (32'b00000000000000000010000000010000));
  assign _zz_305_ = (_zz_318_ == _zz_319_);
  assign _zz_306_ = {_zz_320_,_zz_321_};
  assign _zz_307_ = ((decode_INSTRUCTION & _zz_322_) == (32'b00000000000000000000000001000000));
  assign _zz_308_ = _zz_137_;
  assign _zz_309_ = {_zz_323_,{_zz_324_,_zz_325_}};
  assign _zz_310_ = _zz_138_;
  assign _zz_311_ = _zz_140_;
  assign _zz_312_ = {_zz_326_,_zz_140_};
  assign _zz_313_ = (2'b00);
  assign _zz_314_ = ({_zz_327_,_zz_328_} != (2'b00));
  assign _zz_315_ = (_zz_329_ != _zz_330_);
  assign _zz_316_ = {_zz_331_,{_zz_332_,_zz_333_}};
  assign _zz_317_ = (32'b00000000000000000010000000110000);
  assign _zz_318_ = (decode_INSTRUCTION & (32'b00000000000000000001000000110000));
  assign _zz_319_ = (32'b00000000000000000000000000010000);
  assign _zz_320_ = ((decode_INSTRUCTION & _zz_334_) == (32'b00000000000000000010000000100000));
  assign _zz_321_ = ((decode_INSTRUCTION & _zz_335_) == (32'b00000000000000000000000000100000));
  assign _zz_322_ = (32'b00000000000000000000000001000000);
  assign _zz_323_ = ((decode_INSTRUCTION & _zz_336_) == (32'b00000000000000000100000000100000));
  assign _zz_324_ = (_zz_337_ == _zz_338_);
  assign _zz_325_ = (_zz_339_ == _zz_340_);
  assign _zz_326_ = ((decode_INSTRUCTION & _zz_341_) == (32'b00000000000000000000000000000100));
  assign _zz_327_ = (_zz_342_ == _zz_343_);
  assign _zz_328_ = (_zz_344_ == _zz_345_);
  assign _zz_329_ = (_zz_346_ == _zz_347_);
  assign _zz_330_ = (1'b0);
  assign _zz_331_ = (_zz_139_ != (1'b0));
  assign _zz_332_ = (_zz_348_ != _zz_349_);
  assign _zz_333_ = {_zz_350_,{_zz_351_,_zz_352_}};
  assign _zz_334_ = (32'b00000010000000000010000001100000);
  assign _zz_335_ = (32'b00000010000000000011000000100000);
  assign _zz_336_ = (32'b00000000000000000100000000100000);
  assign _zz_337_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110000));
  assign _zz_338_ = (32'b00000000000000000000000000010000);
  assign _zz_339_ = (decode_INSTRUCTION & (32'b00000010000000000000000000100000));
  assign _zz_340_ = (32'b00000000000000000000000000100000);
  assign _zz_341_ = (32'b00000000000000000000000001000100);
  assign _zz_342_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_343_ = (32'b00000000000000000000000000100000);
  assign _zz_344_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_345_ = (32'b00000000000000000000000000100000);
  assign _zz_346_ = (decode_INSTRUCTION & (32'b00000010000000000100000001100100));
  assign _zz_347_ = (32'b00000010000000000100000000100000);
  assign _zz_348_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000000000000));
  assign _zz_349_ = (1'b0);
  assign _zz_350_ = (_zz_139_ != (1'b0));
  assign _zz_351_ = ({_zz_353_,{_zz_354_,_zz_355_}} != (6'b000000));
  assign _zz_352_ = {(_zz_356_ != (1'b0)),{(_zz_357_ != _zz_358_),{_zz_359_,{_zz_360_,_zz_361_}}}};
  assign _zz_353_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001001000)) == (32'b00000000000000000000000001001000));
  assign _zz_354_ = ((decode_INSTRUCTION & _zz_362_) == (32'b00000000000000000001000000010000));
  ...
  assign _zz_357_ = {(_zz_368_ == _zz_369_),(_zz_370_ == _zz_371_)};
  assign _zz_358_ = (2'b00);
  assign _zz_359_ = ({_zz_372_,_zz_373_} != (2'b00));
  assign _zz_360_ = ({_zz_374_,_zz_375_} != (3'b000));
  assign _zz_361_ = {(_zz_376_ != _zz_377_),{_zz_378_,{_zz_379_,_zz_380_}}};
  ...
  assign _zz_365_ = ((decode_INSTRUCTION & _zz_381_) == (32'b00000000000000000000000000000100));
  assign _zz_366_ = (_zz_382_ == _zz_383_);
  assign _zz_367_ = (_zz_384_ == _zz_385_);
  assign _zz_368_ = (decode_INSTRUCTION & (32'b00010000000100000011000001010000));
  assign _zz_369_ = (32'b00000000000100000000000001010000);
  assign _zz_370_ = (decode_INSTRUCTION & (32'b00010000010000000011000001010000));
  assign _zz_371_ = (32'b00010000000000000000000001010000);
  assign _zz_372_ = ((decode_INSTRUCTION & _zz_386_) == (32'b00000000000000000101000000010000));
  assign _zz_373_ = ((decode_INSTRUCTION & _zz_387_) == (32'b00000000000000000101000000100000));
  assign _zz_374_ = (_zz_388_ == _zz_389_);
  assign _zz_375_ = {_zz_390_,_zz_391_};
  assign _zz_376_ = (_zz_392_ == _zz_393_);
  assign _zz_377_ = (1'b0);
  assign _zz_378_ = ({_zz_394_,_zz_395_} != (3'b000));
  assign _zz_379_ = (_zz_396_ != _zz_397_);
  assign _zz_380_ = {_zz_398_,{_zz_399_,_zz_400_}};
  assign _zz_381_ = (32'b00000000000000000001000000000100);
  assign _zz_382_ = (decode_INSTRUCTION & (32'b00000000000000000000000001010000));
  assign _zz_383_ = (32'b00000000000000000000000000010000);
  assign _zz_384_ = (decode_INSTRUCTION & (32'b00000000000000000000000000101000));
  assign _zz_385_ = (32'b00000000000000000000000000000000);
  assign _zz_386_ = (32'b00000000000000000111000000110100);
  assign _zz_387_ = (32'b00000010000000000111000001100100);
  assign _zz_388_ = (decode_INSTRUCTION & (32'b01000000000000000011000001010100));
  assign _zz_389_ = (32'b01000000000000000001000000010000);
  assign _zz_390_ = ((decode_INSTRUCTION & (32'b00000000000000000111000000110100)) == (32'b00000000000000000001000000010000));
  assign _zz_391_ = ((decode_INSTRUCTION & (32'b00000010000000000111000001010100)) == (32'b00000000000000000001000000010000));
  assign _zz_392_ = (decode_INSTRUCTION & (32'b00000000000000000000000001001000));
  assign _zz_393_ = (32'b00000000000000000000000000001000);
  ...
  assign _zz_396_ = _zz_138_;
  assign _zz_397_ = (1'b0);
  assign _zz_398_ = ((_zz_406_ == _zz_407_) != (1'b0));
  assign _zz_399_ = ({_zz_408_,_zz_409_} != (2'b00));
  assign _zz_400_ = {(_zz_410_ != _zz_411_),{_zz_412_,{_zz_413_,_zz_414_}}};
  assign _zz_401_ = (32'b00000000000000000000000001010000);
  assign _zz_402_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110000));
  ...
  assign _zz_406_ = (decode_INSTRUCTION & (32'b00000000000000000000000001011000));
  assign _zz_407_ = (32'b00000000000000000000000001000000);
  assign _zz_408_ = ((decode_INSTRUCTION & _zz_415_) == (32'b00000000000000000010000000000000));
  assign _zz_409_ = ((decode_INSTRUCTION & _zz_416_) == (32'b00000000000000000001000000000000));
  assign _zz_410_ = {_zz_137_,(_zz_417_ == _zz_418_)};
  assign _zz_411_ = (2'b00);
  assign _zz_412_ = ({_zz_137_,_zz_419_} != (2'b00));
  assign _zz_413_ = ({_zz_420_,_zz_421_} != (2'b00));
  assign _zz_414_ = {(_zz_422_ != _zz_423_),{_zz_424_,{_zz_425_,_zz_426_}}};
  assign _zz_415_ = (32'b00000000000000000010000000010000);
  assign _zz_416_ = (32'b00000000000000000101000000000000);
  assign _zz_417_ = (decode_INSTRUCTION & (32'b00000000000000000000000001110000));
  assign _zz_418_ = (32'b00000000000000000000000000100000);
  assign _zz_419_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000000000));
  assign _zz_420_ = ((decode_INSTRUCTION & _zz_427_) == (32'b00000000000000000001000000000000));
  assign _zz_421_ = _zz_137_;
  assign _zz_422_ = {_zz_137_,(_zz_428_ == _zz_429_)};
  assign _zz_423_ = (2'b00);
  assign _zz_424_ = ((_zz_430_ == _zz_431_) != (1'b0));
  assign _zz_425_ = ({_zz_432_,_zz_433_} != (2'b00));
  assign _zz_426_ = {(_zz_434_ != _zz_435_),{_zz_436_,{_zz_437_,_zz_438_}}};
  assign _zz_427_ = (32'b00000000000000000001000000000000);
  assign _zz_428_ = (decode_INSTRUCTION & (32'b00000000000000000011000000000000));
  assign _zz_429_ = (32'b00000000000000000010000000000000);
  assign _zz_430_ = (decode_INSTRUCTION & (32'b00000010000000000100000001110100));
  assign _zz_431_ = (32'b00000010000000000000000000110000);
  assign _zz_432_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001100100)) == (32'b00000000000000000000000000100100));
  assign _zz_433_ = ((decode_INSTRUCTION & (32'b00000000000000000100000000010100)) == (32'b00000000000000000100000000010000));
  assign _zz_434_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_435_ = (1'b0);
  assign _zz_436_ = ({(_zz_439_ == _zz_440_),{_zz_441_,{_zz_442_,_zz_443_}}} != (4'b0000));
  assign _zz_437_ = ({_zz_444_,_zz_445_} != (2'b00));
  assign _zz_438_ = ({_zz_446_,{_zz_447_,_zz_448_}} != (3'b000));
  assign _zz_439_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_440_ = (32'b00000000000000000000000000000000);
  assign _zz_441_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_442_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000000100)) == (32'b00000000000000000010000000000000));
  assign _zz_443_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000100)) == (32'b00000000000000000001000000000000));
  assign _zz_444_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001010000)) == (32'b00000000000000000001000001010000));
  assign _zz_445_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000001010000));
  assign _zz_446_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000001000000));
  assign _zz_447_ = ((decode_INSTRUCTION & (32'b01000000000000000000000000110000)) == (32'b01000000000000000000000000110000));
  assign _zz_448_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010100)) == (32'b00000000000000000010000000010000));
  always @ (posedge io_clk) begin
    if(_zz_92_) begin
  ...
  assign decode_IS_RS1_SIGNED = _zz_62_;
  ...
  assign _zz_136_ = {({_zz_137_,{_zz_304_,{_zz_305_,_zz_306_}}} != (5'b00000)),{({_zz_307_,{_zz_308_,_zz_309_}} != (5'b00000)),{({_zz_310_,_zz_311_} != (2'b00)),{(_zz_312_ != _zz_313_),{_zz_314_,{_zz_315_,_zz_316_}}}}}};
  assign _zz_75_ = _zz_239_[0];
  assign _zz_74_ = _zz_240_[0];
  assign _zz_73_ = _zz_241_[0];
  assign _zz_141_ = _zz_136_[4 : 3];
  assign _zz_72_ = _zz_141_;
  assign _zz_71_ = _zz_242_[0];
  assign _zz_142_ = _zz_136_[7 : 6];
  assign _zz_70_ = _zz_142_;
  assign _zz_143_ = _zz_136_[9 : 8];
  assign _zz_69_ = _zz_143_;
  assign _zz_68_ = _zz_243_[0];
  assign _zz_144_ = _zz_136_[12 : 11];
  assign _zz_67_ = _zz_144_;
  assign _zz_66_ = _zz_244_[0];
  assign _zz_145_ = _zz_136_[16 : 15];
  assign _zz_65_ = _zz_145_;
  assign _zz_146_ = _zz_136_[18 : 17];
  assign _zz_64_ = _zz_146_;
  assign _zz_63_ = _zz_245_[0];
  assign _zz_62_ = _zz_246_[0];
  assign _zz_61_ = _zz_247_[0];
  assign _zz_60_ = _zz_248_[0];
  assign _zz_59_ = _zz_249_[0];
  assign _zz_58_ = _zz_250_[0];
  assign _zz_147_ = _zz_136_[26 : 25];
  assign _zz_57_ = _zz_147_;
  assign _zz_56_ = _zz_251_[0];
  assign _zz_55_ = _zz_252_[0];
  ...
  assign _zz_19_ = _zz_72_;
  assign _zz_42_ = decode_to_execute_ALU_CTRL;
  assign _zz_37_ = _zz_69_;
