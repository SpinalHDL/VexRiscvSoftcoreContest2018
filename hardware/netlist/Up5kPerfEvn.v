...
module VexRiscv (
  ...
  assign _zz_240_ = _zz_137_[2 : 2];
  assign _zz_241_ = _zz_137_[3 : 3];
  assign _zz_242_ = _zz_137_[4 : 4];
  assign _zz_243_ = _zz_137_[5 : 5];
  assign _zz_244_ = _zz_137_[8 : 8];
  assign _zz_245_ = _zz_137_[13 : 13];
  assign _zz_246_ = _zz_137_[15 : 15];
  assign _zz_247_ = _zz_137_[16 : 16];
  assign _zz_248_ = _zz_137_[19 : 19];
  assign _zz_249_ = _zz_137_[20 : 20];
  assign _zz_250_ = _zz_137_[23 : 23];
  assign _zz_251_ = _zz_137_[24 : 24];
  assign _zz_252_ = _zz_137_[27 : 27];
  ...
  assign _zz_305_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_306_ = (32'b00000000000000000010000000000000);
  assign _zz_307_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000000));
  assign _zz_308_ = (32'b00000000000000000001000000000000);
  assign _zz_309_ = ((decode_INSTRUCTION & _zz_319_) == (32'b00000000000000000000000000000000));
  assign _zz_310_ = (_zz_320_ == _zz_321_);
  assign _zz_311_ = {_zz_322_,_zz_323_};
  assign _zz_312_ = (_zz_324_ == _zz_325_);
  assign _zz_313_ = (_zz_326_ == _zz_327_);
  assign _zz_314_ = {_zz_328_,{_zz_329_,_zz_330_}};
  assign _zz_315_ = (3'b000);
  assign _zz_316_ = ({_zz_331_,_zz_332_} != (5'b00000));
  assign _zz_317_ = (_zz_333_ != _zz_334_);
  assign _zz_318_ = {_zz_335_,{_zz_336_,_zz_337_}};
  ...
  assign _zz_322_ = ((decode_INSTRUCTION & _zz_338_) == (32'b00000000000000000010000000000000));
  assign _zz_323_ = ((decode_INSTRUCTION & _zz_339_) == (32'b00000000000000000001000000000000));
  assign _zz_324_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_325_ = (32'b00000000000000000101000000010000);
  assign _zz_326_ = (decode_INSTRUCTION & (32'b00000010000000000111000001100100));
  assign _zz_327_ = (32'b00000000000000000101000000100000);
  assign _zz_328_ = ((decode_INSTRUCTION & _zz_340_) == (32'b01000000000000000001000000010000));
  assign _zz_329_ = (_zz_341_ == _zz_342_);
  assign _zz_330_ = (_zz_343_ == _zz_344_);
  assign _zz_331_ = _zz_138_;
  assign _zz_332_ = {_zz_345_,{_zz_346_,_zz_347_}};
  assign _zz_333_ = (_zz_348_ == _zz_349_);
  assign _zz_334_ = (1'b0);
  assign _zz_335_ = (_zz_350_ != (1'b0));
  assign _zz_336_ = (_zz_351_ != _zz_352_);
  assign _zz_337_ = {_zz_353_,{_zz_354_,_zz_355_}};
  assign _zz_338_ = (32'b00000000000000000110000000000100);
  assign _zz_339_ = (32'b00000000000000000101000000000100);
  assign _zz_340_ = (32'b01000000000000000011000001010100);
  assign _zz_341_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_342_ = (32'b00000000000000000001000000010000);
  assign _zz_343_ = (decode_INSTRUCTION & (32'b00000010000000000111000001010100));
  assign _zz_344_ = (32'b00000000000000000001000000010000);
  assign _zz_345_ = ((decode_INSTRUCTION & _zz_356_) == (32'b00000000000000000010000000010000));
  assign _zz_346_ = (_zz_357_ == _zz_358_);
  assign _zz_347_ = {_zz_359_,_zz_360_};
  assign _zz_348_ = (decode_INSTRUCTION & (32'b00000000000000000000000001001000));
  assign _zz_349_ = (32'b00000000000000000000000000001000);
  assign _zz_350_ = ((decode_INSTRUCTION & _zz_361_) == (32'b00000000000000000000000001010000));
  assign _zz_351_ = {_zz_362_,_zz_363_};
  assign _zz_352_ = (2'b00);
  assign _zz_353_ = ({_zz_364_,_zz_365_} != (6'b000000));
  assign _zz_354_ = (_zz_366_ != _zz_367_);
  assign _zz_355_ = {_zz_368_,{_zz_369_,_zz_370_}};
  assign _zz_356_ = (32'b00000000000000000010000000110000);
  assign _zz_357_ = (decode_INSTRUCTION & (32'b00000000000000000001000000110000));
  assign _zz_358_ = (32'b00000000000000000000000000010000);
  assign _zz_359_ = ((decode_INSTRUCTION & _zz_371_) == (32'b00000000000000000010000000100000));
  assign _zz_360_ = ((decode_INSTRUCTION & _zz_372_) == (32'b00000000000000000000000000100000));
  assign _zz_361_ = (32'b00010000000000000011000001010000);
  assign _zz_362_ = ((decode_INSTRUCTION & _zz_373_) == (32'b00000000000100000000000001010000));
  assign _zz_363_ = ((decode_INSTRUCTION & _zz_374_) == (32'b00010000000000000000000001010000));
  assign _zz_364_ = (_zz_375_ == _zz_376_);
  assign _zz_365_ = {_zz_377_,{_zz_378_,_zz_379_}};
  assign _zz_366_ = _zz_141_;
  assign _zz_367_ = (1'b0);
  assign _zz_368_ = ({_zz_380_,_zz_381_} != (2'b00));
  assign _zz_369_ = (_zz_382_ != _zz_383_);
  assign _zz_370_ = {_zz_384_,{_zz_385_,_zz_386_}};
  assign _zz_371_ = (32'b00000010000000000010000001100000);
  assign _zz_372_ = (32'b00000010000000000011000000100000);
  assign _zz_373_ = (32'b00010000000100000011000001010000);
  assign _zz_374_ = (32'b00010000010000000011000001010000);
  ...
  assign _zz_377_ = ((decode_INSTRUCTION & _zz_387_) == (32'b00000000000000000001000000010000));
  assign _zz_378_ = (_zz_388_ == _zz_389_);
  assign _zz_379_ = {_zz_390_,{_zz_391_,_zz_392_}};
  assign _zz_380_ = _zz_138_;
  assign _zz_381_ = (_zz_393_ == _zz_394_);
  assign _zz_382_ = {_zz_138_,_zz_395_};
  assign _zz_383_ = (2'b00);
  assign _zz_384_ = ({_zz_396_,_zz_397_} != (3'b000));
  ...
  assign _zz_388_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_389_ = (32'b00000000000000000010000000010000);
  assign _zz_390_ = ((decode_INSTRUCTION & _zz_403_) == (32'b00000000000000000000000000000100));
  assign _zz_391_ = (_zz_404_ == _zz_405_);
  assign _zz_392_ = (_zz_406_ == _zz_407_);
  assign _zz_393_ = (decode_INSTRUCTION & (32'b00000000000000000000000001110000));
  assign _zz_394_ = (32'b00000000000000000000000000100000);
  assign _zz_395_ = ((decode_INSTRUCTION & _zz_408_) == (32'b00000000000000000000000000000000));
  assign _zz_396_ = (_zz_409_ == _zz_410_);
  assign _zz_397_ = {_zz_411_,_zz_412_};
  assign _zz_398_ = {_zz_413_,_zz_414_};
  assign _zz_399_ = (2'b00);
  assign _zz_400_ = ({_zz_415_,_zz_416_} != (3'b000));
  assign _zz_401_ = (_zz_417_ != _zz_418_);
  assign _zz_402_ = {_zz_419_,{_zz_420_,_zz_421_}};
  assign _zz_403_ = (32'b00000000000000000001000000000100);
  assign _zz_404_ = (decode_INSTRUCTION & (32'b00000000000000000000000001010000));
  assign _zz_405_ = (32'b00000000000000000000000000010000);
  assign _zz_406_ = (decode_INSTRUCTION & (32'b00000000000000000000000000101000));
  assign _zz_407_ = (32'b00000000000000000000000000000000);
  assign _zz_408_ = (32'b00000000000000000000000000100000);
  assign _zz_409_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_410_ = (32'b00000000000000000000000001000000);
  assign _zz_411_ = ((decode_INSTRUCTION & _zz_422_) == (32'b01000000000000000000000000110000));
  assign _zz_412_ = ((decode_INSTRUCTION & _zz_423_) == (32'b00000000000000000010000000010000));
  assign _zz_413_ = ((decode_INSTRUCTION & _zz_424_) == (32'b00000000000000000000000000100000));
  ...
  assign _zz_422_ = (32'b01000000000000000000000000110000);
  assign _zz_423_ = (32'b00000000000000000010000000010100);
  assign _zz_424_ = (32'b00000000000000000000000000110100);
  assign _zz_425_ = (32'b00000000000000000000000001100100);
  assign _zz_426_ = (decode_INSTRUCTION & (32'b00000000000000000000000001010000));
  assign _zz_427_ = (32'b00000000000000000000000001000000);
  assign _zz_428_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000110000)) == (32'b00000000000000000000000000000000));
  assign _zz_429_ = ((decode_INSTRUCTION & (32'b00000000010000000011000001000000)) == (32'b00000000000000000000000001000000));
  assign _zz_430_ = _zz_139_;
  assign _zz_431_ = _zz_140_;
  assign _zz_432_ = {(_zz_437_ == _zz_438_),_zz_140_};
  assign _zz_433_ = (2'b00);
  assign _zz_434_ = (_zz_139_ != (1'b0));
  assign _zz_435_ = (_zz_439_ != (1'b0));
  assign _zz_436_ = {(_zz_440_ != _zz_441_),{_zz_442_,{_zz_443_,_zz_444_}}};
  assign _zz_437_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_438_ = (32'b00000000000000000000000000000100);
  assign _zz_439_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  assign _zz_440_ = {(_zz_445_ == _zz_446_),{_zz_138_,{_zz_447_,_zz_448_}}};
  assign _zz_441_ = (5'b00000);
  assign _zz_442_ = ({_zz_449_,_zz_450_} != (2'b00));
  assign _zz_443_ = (_zz_451_ != (1'b0));
  assign _zz_444_ = {(_zz_452_ != _zz_453_),{_zz_454_,{_zz_455_,_zz_456_}}};
  assign _zz_445_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000000));
  assign _zz_446_ = (32'b00000000000000000000000001000000);
  assign _zz_447_ = ((decode_INSTRUCTION & _zz_457_) == (32'b00000000000000000100000000100000));
  ...
  assign _zz_452_ = ((decode_INSTRUCTION & _zz_462_) == (32'b00000010000000000000000000110000));
  assign _zz_453_ = (1'b0);
  assign _zz_454_ = ((_zz_463_ == _zz_464_) != (1'b0));
  assign _zz_455_ = ({_zz_465_,_zz_466_} != (2'b00));
  assign _zz_456_ = {(_zz_467_ != _zz_468_),{_zz_469_,_zz_470_}};
  assign _zz_457_ = (32'b00000000000000000100000000100000);
  assign _zz_458_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110000));
  assign _zz_459_ = (32'b00000000000000000000000000010000);
  assign _zz_460_ = (decode_INSTRUCTION & (32'b00000010000000000000000000100000));
  assign _zz_461_ = (32'b00000000000000000000000000100000);
  assign _zz_462_ = (32'b00000010000000000100000001110100);
  assign _zz_463_ = (decode_INSTRUCTION & (32'b00000000000000000000000001011000));
  assign _zz_464_ = (32'b00000000000000000000000000000000);
  assign _zz_465_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001010000)) == (32'b00000000000000000001000001010000));
  assign _zz_466_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000001010000));
  ...
  assign _zz_469_ = ({((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000)),_zz_138_} != (2'b00));
  assign _zz_470_ = ({_zz_138_,((decode_INSTRUCTION & (32'b00000000000000000011000000000000)) == (32'b00000000000000000010000000000000))} != (2'b00));
  always @ (posedge io_clk) begin
    if(_zz_94_) begin
  ...
  assign _zz_137_ = {({(_zz_305_ == _zz_306_),(_zz_307_ == _zz_308_)} != (2'b00)),{({_zz_309_,{_zz_310_,_zz_311_}} != (4'b0000)),{({_zz_312_,_zz_313_} != (2'b00)),{(_zz_314_ != _zz_315_),{_zz_316_,{_zz_317_,_zz_318_}}}}}};
  assign _zz_142_ = _zz_137_[1 : 0];
  assign _zz_78_ = _zz_142_;
  assign _zz_77_ = _zz_240_[0];
  assign _zz_76_ = _zz_241_[0];
  assign _zz_75_ = _zz_242_[0];
  assign _zz_74_ = _zz_243_[0];
  assign _zz_143_ = _zz_137_[7 : 6];
  assign _zz_73_ = _zz_143_;
  assign _zz_72_ = _zz_244_[0];
